...
public class MusicReader {
     ...
     * @param <MusicModel> The main model interface type describing music compositions
     * @return new Model.
     */
    public static <MusicModel> MusicModel parseFile(Readable readable,
                                                    CompositionBuilder<MusicModel> piece) {
