 ...
 * by an unknown type.
 *
 * @param <MusicModel> The type of the constructed composition
 */
public interface CompositionBuilder<MusicModel> {
    /**
     ...
     * @return This builder
     */
    CompositionBuilder<MusicModel> setTempo(int tempo);
     ...
     * @return new Builder.
     */
    CompositionBuilder<MusicModel> addNote(int start, int end, int instrument, int pitch, int volume);
}
